...
dicas_especificas = {
    ...
    "febre": [
        "Mantenha-se hidratado, bebendo bastante água e chás.",
        "Use compressas mornas na testa para ajudar a reduzir a temperatura.",
        "Descanse bastante e evite esforço físico.",
        "Use medicamentos antitérmicos apenas se necessário e conforme orientação médica."
    ],
    "dor no coração":[
        "Dor no coração pode ser um sinal sério. Procure atendimento médico imediatamente.",
        "Evite esforço físico intenso e mantenha a calma até receber ajuda.",
        "Anote os sintomas associados para informar ao médico.",
        "Não hesite em buscar ajuda médica se sentir dor no peito."
    ],
    "dor de barriga": [
        "Evite alimentos pesados e gordurosos até que a dor passe.",
        "Mantenha-se hidratado, bebendo água ou chás claros.",
        "Considere chá de camomila ou gengibre para ajudar na digestão.",
        "Se a dor persistir ou piorar, consulte um médico."
    ],
    "alimentação_saudável": [
        "Inclua mais frutas e vegetais na sua dieta diária.",
        "Evite alimentos ultraprocessados e opte por alimentos naturais.",
        "Beba bastante água ao longo do dia.",
        "Mantenha um diário alimentar para monitorar o que come.",
        "Evite pular refeições e faça lanches saudáveis entre elas."
    ],
    "exercícios_físicos": [
        "Tente caminhar pelo menos 30 minutos por dia.",
        "Inclua exercícios de força 2-3 vezes por semana.",
        "Experimente atividades que você goste, como dança ou natação.",
        "Use aplicativos para monitorar sua atividade física e manter-se motivado."
    ],
    "saúde_mental": [
        "Pratique técnicas de respiração profunda para relaxar.",
        "Reserve um tempo para hobbies que você gosta.",
        "Conecte-se com amigos e familiares regularmente.",
        "Considere meditação ou yoga como parte da sua rotina."
    ],
    "primeiros_socorros": [
        "Aprenda a fazer a manobra de Heimlich para engasgos.",
        "Tenha sempre um kit de primeiros socorros em casa.",
        "Saiba como tratar queimaduras leves com água corrente.",
        "Aprenda a reconhecer sinais de AVC e como agir rapidamente."
    ],
    "dormir_melhor": [
    ...
    "covid": [
        "Mantenha-se atualizado sobre as vacinas disponíveis e suas recomendações.",
        "Use máscara em locais fechados e com aglomeração.",
        "Lave as mãos frequentemente e use álcool em gel.",
        "Evite tocar o rosto e mantenha distância de pessoas doentes."
    ],
    "cansado": [
        "Tente identificar a causa do cansaço: sono, estresse, alimentação.",
        "Pratique atividade física regularmente para aumentar a energia.",
        "Mantenha uma alimentação balanceada e rica em nutrientes.",
        "Considere técnicas de relaxamento como meditação ou yoga."
    ],
    "ansiedade": [
        "Pratique técnicas de respiração profunda para acalmar a mente.",
        "Experimente meditação ou mindfulness para reduzir a ansiedade.",
        "Mantenha uma rotina regular de sono e alimentação.",
        "Considere procurar um profissional de saúde mental se a ansiedade persistir."
    ],
    "prevenção": [
        "Mantenha uma alimentação balanceada e rica em nutrientes.",
        "Pratique atividade física regularmente para fortalecer o sistema imunológico.",
        "Evite fumar e limite o consumo de álcool.",
        "Realize exames preventivos conforme recomendado pelo seu médico.",
        "Mantenha-se atualizado sobre vacinas e imunizações."
    ],
    "dor de cabeça": [
        "Mantenha-se hidratado e evite ficar muito tempo sem comer.",
        "Pratique técnicas de relaxamento, como meditação ou yoga.",
        "Evite cafeína e alimentos processados em excesso.",
        "Considere manter um diário para identificar gatilhos da dor de cabeça."
    ],
    "tosse":[
        "Mantenha-se hidratado e beba chás quentes.",
        "Use um umidificador para manter o ar úmido.",
        "Evite fumar e ambientes com fumaça.",
        "Considere mel ou xaropes naturais para aliviar a tosse seca."
    ],
    "dor no peito": [
        "Dor no peito pode ser um sinal sério. Procure atendimento médico imediatamente.",
        "Evite esforço físico intenso e mantenha a calma até receber ajuda.",
        "Anote os sintomas associados para informar ao médico.",
        "Não hesite em buscar ajuda médica se sentir dor no peito."
    ],
    "outros sintomas": [
        "Se você está com sintomas persistentes, é importante consultar um médico.",
        "Mantenha-se hidratado e descanse o máximo possível.",
        "Evite automedicação e busque orientação profissional.",
        "Anote os sintomas e quando começaram para facilitar a consulta médica."
    ],
}
...
categorias = {
    "nutricao": [
        [r"(.*)alimentação saudável(.*)", ["Uma alimentação saudável deve ser variada e colorida, incluindo todos os grupos alimentares em proporções adequadas. Priorize alimentos naturais, limite ultraprocessados e mantenha boa hidratação.Gostaria de dicas específicas sobre algum grupo alimentar?"]],
        [r"(.*)dieta(.*)", ["Dietas restritivas podem levar a deficiências nutricionais. O ideal é adotar hábitos saudáveis e sustentáveis a longo prazo. Consulte um nutricionista para um plano personalizado."]],
        [r"(.*)calorias(.*)", ["O controle de calorias é importante para manter o peso saudável. O ideal é consumir menos calorias do que gasta, mas sem exageros. Uma dieta equilibrada e variada é fundamental."]],
        [r"(.*)nutrientes(.*)", ["Os principais nutrientes são carboidratos, proteínas, gorduras, vitaminas e minerais. Cada um desempenha funções essenciais no corpo. Uma dieta equilibrada deve incluir todos eles."]],
        [r"(.*)vitaminas(.*)", ["As vitaminas são essenciais para diversas funções do corpo. As mais conhecidas são A, C, D, E e K. Cada uma tem suas funções específicas. Uma alimentação variada geralmente fornece todas as vitaminas necessárias."]],
        [r"(.*)minerais(.*)", ["Os minerais são fundamentais para a saúde óssea, muscular e metabólica. Os principais são cálcio, ferro, magnésio, zinco e potássio. Uma dieta equilibrada geralmente fornece os minerais necessários."]],
...
def buscar_por_categoria(pergunta):
    for categoria, pares_categoria in categorias.items():
        for regex, respostas in pares_categoria:
            # verificar uma melhor forma de fazer isso, utilizando muitos 'elif' não é o ideal.
            if re.search(regex, pergunta, re.IGNORECASE):
                contexto["topico_atual"] = categoria
                if "diabetes" in regex:
                    contexto["subtopico"] = "prevenção_diabetes"
                elif "alimentação saudável" in regex:
                    contexto["subtopico"] = "alimentação_saudável"
                elif "exercício" in regex:
                    contexto["subtopico"] = "exercícios_físicos"
                elif "saúde mental" in regex:
                    contexto["subtopico"] = "saúde_mental"
                elif "primeiros socorros" in regex:
                    contexto["subtopico"] = "primeiros_socorros"
                elif "covid" in regex:
                    contexto["subtopico"] = "covid"
                elif "cansado" in regex:
                    contexto["subtopico"] = "cansado"
                elif "ansiedade" in regex:
                    contexto["subtopico"] = "ansiedade"
                elif "dor de cabeça" in regex:
                    contexto["subtopico"] = "dor de cabeça"
                elif "dormir melhor" in regex:
                    contexto["subtopico"] = "dormir melhor"
                elif "prevenção" in regex:
                    contexto["subtopico"] = "prevenção"
                elif "tosse" in regex:
                    contexto["subtopico"] = "tosse"
                elif "outros sintomas" in regex:
                    contexto["subtopico"] = "outros sintomas"
                elif "dor no peito" in regex:
                    contexto["subtopico"] = "dor no peito"
                elif "dor de barriga" in regex:
                    contexto["subtopico"] = "dor de barriga"
                elif "dor no coração" in regex:
                    contexto["subtopico"] = "dor no coração"
                elif "febre" in regex:
                    contexto["subtopico"] = "febre"
                else:
                    contexto["subtopico"] = None
                return random.choice(respostas)
    return None

# Salva a conversa, está funcionando porém adicionar botão para deletar conversa futuramente.
...
def chat():
    ...
    confirmacoes = ["sim", "claro", "com certeza", "certamente", "combinado"]
    negacoes = ["não", "nao", "de jeito nenhum", "nunca", "jamais", "negativo"]

    if user_input in confirmacoes and contexto.get("subtopico"):
        dicas = dicas_especificas.get(contexto["subtopico"])
        if dicas:
            response = "Aqui estão algumas dicas específicas:\n- " + "\n- ".join(dicas)
            contexto["subtopico"] = None
            return jsonify({"response": response})
    
    if user_input in negacoes and contexto.get("subtopico"):
        contexto["subtopico"] = None
        return jsonify({"response": "Tudo bem! Se precisar de mais alguma coisa, estou à disposição. Cuide-se!"})

    # tenta responder com base nas categorias
    response = buscar_por_categoria(user_input)

    # se não encontrar a resposta em categoria segue pelos pares padrões
    if not response:
